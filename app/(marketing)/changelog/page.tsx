...
function parseChangelog(body: string | undefined, noReleaseNotes: string): string {
  if (!body) return `<p class="text-slate-500">${noReleaseNotes}</p>`;
    ...
    <>
        ...
        <div className="container max-w-4xl">
          {hasReleases ? (
              ...
              {releases.map((release, idx) => (
                <article key={release.tag} className="relative">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: parseChangelog(release.changelog, t("noReleaseNotes")) }}
                  />
            ...
            <div className="text-center py-16">
              ...
              <h2 className="font-heading text-2xl mb-2">{t("noReleases")}</h2>
      ...
      <section className="py-12 bg-slate-50 dark:bg-slate-900">
        <div className="container text-center">
          <h2 className="font-heading text-2xl mb-4">{t("cta.title")}</h2>
