...
export default function RoadmapClient() {
  ...
  const updatedDate = isZh ? "2026 年 1 月" : "January 2026"

  const statusLabel = (status: keyof typeof statusIcons) => {
    switch (status) {
      case "done":
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <p className="text-slate-400 text-sm">{t("stats.done")}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <p className="text-slate-400 text-sm">{t("stats.inProgress")}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <p className="text-slate-400 text-sm">{t("stats.planned")}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <p className="text-slate-400 text-sm">{t("stats.progress")}</p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex justify-between text-sm mb-2">
              <span className="text-slate-400">{t("stats.overallProgress")}</span>
        ...
        <div className="container">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                {t("filter.all", { count: stats.total })}
              </button>
        ...
        <div className="container max-w-6xl">
                  ...
                  <div className="pt-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h2 className="font-heading text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">
                        {isZh ? phase.titleZh || phase.title : phase.title}
                      </h2>
                      <span className="hidden sm:inline-block px-3 py-1 rounded-full text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400">
                        {t("phase.items", { count: phase.items.length })}
                      </span>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400 flex items-center gap-2">
                      <Calendar className="w-4 h-4" weight="light" />
                      {isZh ? phase.timeframeZh || phase.timeframe : phase.timeframe}
                    </p>
                  </div>
                </div>
          ...
          {filteredPhases.length === 0 && (
            ...
            >
              ...
              <h3 className="text-lg font-medium text-slate-900 dark:text-white mb-2">{t("empty.title")}</h3>
              <p className="text-slate-500">{t("empty.desc")}</p>
            </motion.div>
          )}
        </div>
      </section>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                ...
                <span className="font-medium">{t("cta.issue")}</span>
              ...
              >
                ...
                <span className="font-medium">{t("cta.discord")}</span>
              </motion.a>
            </div>

            {/* Trust indicators */}
            <p className="mt-8 text-sm text-slate-400">
              {t("cta.trust", { count: "2,400" })}
            </p>
          </motion.div>
        </div>
      </section>
