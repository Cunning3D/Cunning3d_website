...
See [Loader API `source`](/docs/cda/source-api/source) for details.
...
See [Definitions of Page Tree](/docs/cda/page-tree).
...
You may need table of contents, which can be generated on your own, or using the [`getTableOfContents`](/docs/cda/utils/get-toc) utility (Markdown/MDX only).
...
For Markdown and MDX, the built-in [Search API](/docs/cda/search/orama) + search index usage is adequate for most use cases.
...
Fumadocs offers a variant of [Search Integrations](/docs/cda/search).
