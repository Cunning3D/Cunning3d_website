...
To access the `source` object outside of app runtime, configure [Fumadocs MDX Loader](/docs/platforms/loader/bun) first.
...
> For Node.js, you might need to configure `tsconfig-paths`, TypeScript transpiling, and [Fumadocs MDX Loader](/docs/platforms/loader/node).
>
