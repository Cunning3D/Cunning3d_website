...
> See [available options](/docs/cda/internationalization) for i18n config.
...
Make sure its behaviour aligns with the [`hidePrefix`](/docs/cda/internationalization#hide-locale-prefix) option you set in your i18n config.
...
- **Built-in Search (Orama):** See [Internationalization](/docs/cda/search/orama#internationalization).
...
In addition, the [`fumadocs-core/dynamic-link`](/docs/cda/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to prepend the locale prefix.
