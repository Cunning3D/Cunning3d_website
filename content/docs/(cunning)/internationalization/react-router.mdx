...
In addition, the [`fumadocs-core/dynamic-link`](/docs/cda/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
