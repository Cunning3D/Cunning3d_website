...
You can use the [`schema`](/docs/platforms/collections#schema-1) option to add frontmatter properties.
...
<DocsCategory url="/docs/nodes/navigation" />
...
Syntax Highlighting is supported by default using [Rehype Code](/docs/cda/mdx/rehype-code).
...
See [other usages of include](/docs/platforms/include).
...
See [`remark-npm`](/docs/cda/mdx/remark-npm) for details.

### Other Components

You can configure & use the [built-in components](/docs/nodes/components) in your MDX document, such as Tabs, Accordions and Zoomable Image.
