...
<Card icon={<LinkIcon />} title="Layout Links" href="/docs/nodes/layouts/links">
...
<Card icon={<PanelLeftDashed />} title="Sidebar Items" href="/docs/nodes/layouts/docs#sidebar-items">
