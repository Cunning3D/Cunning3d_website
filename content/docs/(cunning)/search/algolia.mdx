...
For the setup guide, see [Integrate Algolia Search](/docs/cda/search/algolia).
...
Optionally, you can add UI for filtering results by tags. Configure [Tag Filter](/docs/cda/search/algolia#tag-filter) on search server and add the following:
