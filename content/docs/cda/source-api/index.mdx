...
- Generate [page slugs and page tree](/docs/cda/page-conventions).
...
You can use it with content sources like Fumadocs MDX, see [`source`](/docs/cda/source-api/source) for details.
...
Load the [icon](/docs/cda/page-conventions#icons) property specified by page and meta files.
...
If translations are missing for a page, it fallbacks to [`fallbackLanguage`](/docs/cda/internationalization#fallback-language).
