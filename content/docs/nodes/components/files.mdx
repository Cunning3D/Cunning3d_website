...
<auto-type-table cwd path="content/docs/nodes/props.ts" name="FileProps" />

### Folder

<auto-type-table cwd path="content/docs/nodes/props.ts" name="FolderProps" />

## Remark Plugin

You can enable [`remark-mdx-files`](/docs/cda/mdx/remark-mdx-files) for additional feature & syntax.
