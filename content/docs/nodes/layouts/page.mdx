...
You can enable [`lastModified`](/docs/platforms/last-modified).
...
the [`getGithubLastEdit`](/docs/cda/utils/git-last-edit) utility.
...
[TOC Utility](/docs/cda/utils/get-toc). Content sources like Fumadocs MDX offer this out-of-the-box.
...
<auto-type-table cwd path="content/docs/nodes/props.ts" name="TOCProps" />
...
<auto-type-table cwd path="content/docs/nodes/props.ts" name="FooterProps" />

### Breadcrumb

A navigation element, shown only when user is navigating in folders.

<auto-type-table cwd path="content/docs/nodes/props.ts" name="BreadcrumbProps" />
