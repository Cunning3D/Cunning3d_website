...
The context provider of all the components, including `next-themes` and [`<FrameworkProvider />`](/docs/cda#installation). It should be located at the root layout.
...
Learn more from [Search](/docs/nodes/search).
